#!/bin/bash
BSH_DIR=$BSH_EXO_BASE_DIRECTORY/projects/eXoProjects/tools/trunk/build

CURRENT_DIR=`pwd`
JAVA_CMD=$BSH_JAVA_HOME/bin/java
echo $@
$JAVA_CMD -Xshare:auto -Xms128m -Xmx512m -classpath $BSH_DIR/src/main/resources/bsh-2.0b4.jar  \
