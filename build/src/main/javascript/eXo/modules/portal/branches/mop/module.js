...
function getModule(params) {
  ...
  module.component.portal  = 
    ...
    addDependency(new Project("org.gatein.mop", "mop.api", "jar", "1.0.0-beta1")).
    addDependency(new Project("org.gatein.mop", "mop.spi", "jar", "1.0.0-beta1")).
    addDependency(new Project("org.gatein.mop", "mop.core", "jar", "1.0.0-beta1")).
