...
function getModule(params) {
  ...
  module.version = "2.3.0.SC_19" ;
  module.relativeMavenRepo =  "org/exoplatform/ecm/dms" ;
  module.relativeSRCRepo =  "patches/secours-catholique/ecm/dms/tags/2.3.0.SC_19" ;
  module.name =  "dms" ;
    
  module.portlet = {}
  module.portlet.dms = 
    new Project("org.exoplatform.ecm.dms.core", "exo.ecm.dms.core.portlet.ecm", "exo-portlet", module.version).
    addDependency(new Project("org.exoplatform.ecm.dms.core", "exo.ecm.dms.core.portlet.ecm", "war",  module.version)) .     
  ...
  module.gadgets = 
    ...
    addDependency(new Project("org.exoplatform.ws", "exo.ws.frameworks.json", "jar", "1.3.5"));  
