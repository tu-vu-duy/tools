...
function getModule(params) {
  ...
  module.relativeSRCRepo =  "jcr/tags/1.9" ;
  module.name =  "jcr" ;
...
//		addDependency(new Project("stax", "stax", "jar", "1.2.0")).
  ...
  module.frameworks.web = 
    ...
    addDependency(new Project("org.exoplatform.ws", "exo.ws.rest.core", "jar", "1.2")).
    addDependency(new Project("org.exoplatform.ws", "exo.ws.commons", "jar", "1.2")).
