...
function getModule(params) {
  ...
  module.version = "1.0-beta2" ;
  module.relativeMavenRepo = "org/exoplatform/liveroom" ;
  module.relativeSRCRepo = "liveroom/tags/1.0-beta2" ;
...
function configServer(server) {
  ...
  desc.openfireJar = "exo.liveroom.eXoApplication.organization.client.openfire-1.0-beta2.jar" ;
