...
function getModule(params) {
  ...
  module.relativeSRCRepo =  "cp130709/tags/0.8" ;
  ...
  module.portlet.strutsAlmerysPortlet = 
	...
	addDependency(new Project("com.almerys.emut.lmgv2", "lmgv2-portal-filters", "jar", "0.2.7.0.0")).
	addDependency(new Project("com.almerys.emut.lmgv2", "lmgv2-adherent-common-model", "jar", "0.3.5.0.0")).
