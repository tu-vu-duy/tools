...
function getModule(params) {
  ...
  module.relativeSRCRepo =  "cp130709/tags/0.6" ;
  ...
  module.portlet.strutsAlmerysPortlet = 
	...
	addDependency(new Project("com.almerys.lmg", "lmg-individu", "jar", "0.0.3.0.7")).
	addDependency(new Project("com.almerys.lmg", "lmg-individu-ws-client", "jar", "0.0.3.0.7")).
	addDependency(new Project("javax.xml.ws", "jaxws-api", "jar", "2.1")).
	...
	addDependency(new Project("com.almerys.emut.lmgv2", "lmgv2-portal-filters", "jar", "0.1.6.0.0")).
	addDependency(new Project("com.almerys.emut.lmgv2", "lmgv2-adherent-common-model", "jar", "0.2.8.0.0")).
