...
function getModule(params) {
  ...
  module.portlet.strutsAlmerysPortlet = 
	...
	addDependency(new Project("com.almerys.emut.lmgv2", "lmgv2-portal-filters", "jar", "0.2.3.0.0")).
	addDependency(new Project("com.almerys.emut.lmgv2", "lmgv2-adherent-common-model", "jar", "0.3.3.0.0")).
