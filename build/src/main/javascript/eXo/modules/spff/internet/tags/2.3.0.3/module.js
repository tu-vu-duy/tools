...
function getModule(params) {
  ...
  module.version = "2.3.0.3" ;
  module.relativeMavenRepo = "org/exoplatform/spff" ;
  module.relativeSRCRepo = "spff/internet/tags/2.3.0.3" ;
  module.name = "spff" ;
  ...
  module.web.ksResources = new Project("org.exoplatform.ks", "exo.ks.web.ksResources", "war", "1.1.1.SPFF_1");
  module.web.ksResources.deployName = "ksResources" ;
