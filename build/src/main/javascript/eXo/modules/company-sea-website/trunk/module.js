...
function getModule(params) {
  ...
  module.portlet = {}
  module.portlet.web = new Project("org.exoplatform.CompanySeaWebsite", "CompanySeaWebsite.portlet.web", "exo-portlet", module.version);
  module.portlet.web.deployName = "CompanySeaWebsitePortletWeb" ;

  module.portlet.dms = 
    new Project("org.exoplatform.CompanySeaWebsite", "CompanySeaWebsite.portlet.ecm", "exo-portlet", module.version).
    addDependency(new Project("org.exoplatform.CompanySeaWebsite", "CompanySeaWebsite.component.cms", "jar",  module.version)) .      
    addDependency(new Project("org.exoplatform.CompanySeaWebsite.bp", "exo.CompanySeaWebsite.bp.jbpm.contactus", "jar", module.version)) .
  ...
  module.component.web=
    new Project("org.exoplatform.CompanySeaWebsite", "CompanySeaWebsite.component.web", "jar", module.version).
    addDependency(portal.component.web);
  
  module.web = {}  
  module.web.CompanySeaWebsiteResources = 
    new Project("org.exoplatform.CompanySeaWebsite", "CompanySeaWebsite.web.eXoResourcesCompany", "exo-portal", module.version) ;    
  module.web.portal = 
    new Project("org.exoplatform.CompanySeaWebsite", "CompanySeaWebsite.web.portal", "exo-portal", module.version).
  ...
  module.eXoApplication.calendar = 
    new Project("org.exoplatform.CompanySeaWebsite", "exo.CompanySeaWebsite.cs.eXoApplication.calendar.webapp", "war", module.version).
  ...
  module.server.tomcat.patch = 
    new Project("org.exoplatform.CompanySeaWebsite", "CompanySeaWebsite.server.tomcat.patch", "jar", module.version);
