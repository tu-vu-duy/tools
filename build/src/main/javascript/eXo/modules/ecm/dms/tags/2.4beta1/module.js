...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/dms/tags/2.4beta1" ;
  product.useContentvalidation = true;
  product.contentvalidationVersion = "2.4beta1";
  ...
  var dms = Module.GetModule("ecm/dms/tags/2.4beta1", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, ws : ws, eXoJcr : eXoJcr, portal : portal});
