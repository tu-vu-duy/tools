...
function getModule(params) {
  ...
  module.version = "2.3.0-Beta01" ;
  module.relativeMavenRepo = "org/exoplatform/core" ;
  module.relativeSRCRepo = "core/tags/2.3.0-Beta01" ;
  module.name = "core" ;
  ...
  module.component.database = 
    ...
    addDependency(new Project("org.hibernate", "hibernate-cglib-repack", "jar", "2.1_3")).
  ...
  module.component.documents =
    ...
    addDependency(new Project("org.htmlparser", "htmlparser", "jar", "1.6")).
