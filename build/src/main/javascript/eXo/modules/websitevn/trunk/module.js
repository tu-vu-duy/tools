...
function getModule(params) {
  ...
  module.relativeMavenRepo =  "org/exoplatform/websitevn" ;
  module.relativeSRCRepo =  "websitevn/trunk" ;
  module.name =  "websitevn" ;
  ...
  module.portlet = {}
  module.portlet.web = new Project("org.exoplatform.websitevn", "websitevn.portlet.web", "exo-portlet", module.version);
  module.portlet.web.deployName = "websitevnPortletWeb" ;

  module.portlet.dms = 
    new Project("org.exoplatform.websitevn", "websitevn.portlet.ecm", "exo-portlet", module.version).
    addDependency(new Project("org.exoplatform.websitevn", "websitevn.component.cms", "jar",  module.version)) .      
    addDependency(new Project("org.exoplatform.websitevn.bp", "exo.websitevn.bp.jbpm.contactus", "jar", module.version)) .
  ...
  module.component.web=
    new Project("org.exoplatform.websitevn", "websitevn.component.web", "jar", module.version).
  ...
  module.eXoApplication.calendar = 
    new Project("org.exoplatform.websitevn", "exo.websitevn.cs.eXoApplication.calendar.webapp", "war", module.version).
  ...
  module.server.tomcat.patch = 
    new Project("org.exoplatform.websitevn", "websitevn.server.tomcat.patch", "jar", module.version);
