...
function getModule(params) {
  ...
  module.relativeSRCRepo =  "cp060508/branches/2.1" ;
  ...
  module.portlet.web.deployName = "cp060508PortletWeb" ;
	...
	module.skin.webpresentation = new Project("org.exoplatform.cp060508", "cp060508.skin.webpresentation", "exo-portlet", module.version).       
   	 	addDependency(new Project("org.exoplatform.ecm", "exo.ecm.wcm.connector.fckeditor", "jar",  wcm.version)).
   	 	addDependency(new Project("org.exoplatform.ecm", "exo.ecm.wcm.component.wcm", "jar",  wcm.version)).
  	  addDependency(new Project("org.exoplatform.ecm", "exo.ecm.wcm.webui.wcm", "jar",  wcm.version)).
   		addDependency(new Project("org.exoplatform.ecm", "exo.ecm.wcm.component.publication", "jar",  wcm.version)).    
    	addDependency(ws.frameworks.json).
    	addDependency(jcr.frameworks.command).
    	addDependency(jcr.frameworks.web).
    	addDependency(portal.webui.portal);
    module.skin.webpresentation.deployName = "presentation" ;
    
 	module.skin.websearches = new Project("org.exoplatform.cp060508", "cp060508.skin.websearches", "exo-portlet", module.version).    
    	addDependency(new Project("org.exoplatform.ecm", "exo.ecm.wcm.component.wcm", "jar",  wcm.version)).
    	addDependency(new Project("org.exoplatform.ecm", "exo.ecm.wcm.component.search", "jar",  wcm.version));
	module.skin.websearches.deployName = "searches" ;
