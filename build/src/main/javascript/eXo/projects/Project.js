...
function Project(gid, id, ptype, version) {
    ...
    // print("Project.js: new Project(gid: " + gid + " id: " + id + " ptype: "+
    ...
    if (ptype == "exo-portlet" || ptype == "exo-portal")
        this.extension = "war";
    if (ptype == "exo-ear-jar")
        this.extension = "jar";
    if (ptype == "exopc-war")
        this.extension = "exopc-war";
    if (ptype == "exo-ear-rar")
        this.extension = "rar";
    this.relativePath = gid.replace(/\./g, '/') + "/" + id + "/" + version + "/" + id + "-" + version + "." + this.extension;
...
Project.prototype.setServerDependency = function(name, b) {
    if ("tomcat" == name)
        this.tomcatDependency = b;
    else if ("jboss" == name)
        this.jbossDependency = b;
    else if ("jbossear" == name)
        this.jbossearDependency = b;
    else if ("ear" == name)
        this.earDependency = b;
    else if ("jonas" == name)
        this.jonasDependency = b;
}
...
Project.prototype.hasDependency = function() {
