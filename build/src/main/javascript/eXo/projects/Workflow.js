  ...
  product.addDependencies(workflow.portlet.workflow);
	...
	if(this.name == "jbpm") {
      ...
      product.addDependencies(new Project("org.exoplatform.ecm.contentvalidation", "exo.ecm.contentvalidation.component.workflowPublication", "jar", this.version));
			...
			product.addDependencies(new Project("org.exoplatform.ecm.contentvalidation", "exo.ecm.contentvalidation.bp.bonita.content.backup", "jar", this.version));
			product.addDependencies(new Project("org.exoplatform.ecm.contentvalidation", "exo.ecm.contentvalidation.bp.bonita.content.validation", "jar", this.version));
		}
