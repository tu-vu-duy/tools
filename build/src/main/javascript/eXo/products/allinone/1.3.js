...
function getProduct(version) {
  ...
  product.codeRepo = "allinone/branches/1.3" ;
  ...
  var allinone = Module.GetModule("allinone/branches/1.3", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, webos: webos, cs: cs, ks: ks, dms : dms, wcm: wcm,workflow : workflow});
