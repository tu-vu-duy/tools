...
function getProduct(version) {
  ...
  product.codeRepo = "allinone/branches/1.4.x" ;
  ...
  var allinone = Module.GetModule("allinone/branches/1.4.x", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, cs: cs, ks: ks, dms : dms, wcm: wcm,workflow : workflow});
  ...
  product.removeDependency(new Project("org.exoplatform.ws", "exo.ws.frameworks.json", "jar", "1.3.2"));
