...
function getProduct(version) {
  ...
  product.codeRepo = "allinone/tags/1.4rc1" ;
  ...
  var allinone = Module.GetModule("allinone/tags/1.4rc1", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, cs: cs, ks: ks, dms : dms, wcm: wcm,workflow : workflow});
