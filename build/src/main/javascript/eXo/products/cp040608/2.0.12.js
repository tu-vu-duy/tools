...
function getProduct(version) {
  ...
  product.codeRepo = "cp040608/tags/2.0.12" ;
  ...
  var cp040608 = Module.GetModule("cp040608/tags/2.0.12", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, ecm : ecm, workflow : workflow});
