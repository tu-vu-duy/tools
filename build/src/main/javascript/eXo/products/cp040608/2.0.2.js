...
function getProduct(version) {
  ...
  product.codeRepo = "cp040608/tags/2.0.2" ;
  ...
  var ecm = Module.GetModule("cp040608/patches/ecm/dms/tags/2.3.0.SC_15", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, ws : ws, eXoJcr : eXoJcr, portal : portal});
  ...
  var ks = Module.GetModule("cp040608/patches/ks/tags/1.1.2.SC_10", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
  var cp040608 = Module.GetModule("cp040608/tags/2.0.2", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, ecm : ecm, workflow : workflow});
