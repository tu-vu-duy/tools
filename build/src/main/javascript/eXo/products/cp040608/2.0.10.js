...
function getProduct(version) {
  ...
  product.codeRepo = "cp040608/tags/2.0.10" ;
  product.useWorkflow = true;
  product.useContentvalidation = true;
  product.contentvalidationVersion = "2.3";
  product.workflowVersion = "1.0.6" ;
  product.serverPluginVersion = "2.5.2.SC_12" ;
  ...
  var portal = Module.GetModule("cp040608/patches/portal/tags/2.5.2.SC_12", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr });
  var ecm = Module.GetModule("cp040608/patches/ecm/dms/tags/2.3.0.SC_22", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, ws : ws, eXoJcr : eXoJcr, portal : portal});
  ...
  var cp040608 = Module.GetModule("cp040608/tags/2.0.10", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, ecm : ecm, workflow : workflow});
