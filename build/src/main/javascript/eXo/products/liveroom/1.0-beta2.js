...
function getProduct(version) {
  ...
  var liveroom = Module.GetModule("liveroom/tags/1.0-beta2", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal}) ;
  ...
  product.codeRepo = "liveroom/tags/1.0-beta2" ;
