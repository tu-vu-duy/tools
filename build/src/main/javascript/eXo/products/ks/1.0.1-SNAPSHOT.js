...
function getProduct(version) {
  ...
  var ks = Module.GetModule("ks/branches/1.0.x", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
  ...
  product.codeRepo = "ks/branches/1.0.x" ;
