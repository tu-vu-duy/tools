...
function getProduct(version) {
  ...
  var ks = Module.GetModule("ks/tags/1.2.1", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
  ...
  product.codeRepo = "ks/tags/1.2.1" ;
