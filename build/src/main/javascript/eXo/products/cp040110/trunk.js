...
function getProduct(version) {
	...
	product.codeRepo = "cp040110/trunk";
	...
	var cp040110 = Module.GetModule("cp040110/trunk", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, cs: cs, ks: ks, dms : dms, wcm : wcm});
