...
function getProduct(version) {
	...
	product.name = "cp040110Product";
	product.portalwar = "portal.war";
	product.codeRepo = "cp040110/tags/1.0";
	...
	var cp040110 = Module.GetModule("cp040110/tags/1.0", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, cs: cs, ks: ks, dms : dms, wcm : wcm});
	...
	product.addDependencies(cp040110.portlet.dms);
