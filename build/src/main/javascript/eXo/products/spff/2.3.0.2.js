...
function getProduct(version) {
  ...
  product.codeRepo = "spff/internet/tags/2.3.0.2" ;
  ...
  var spff = Module.GetModule("spff/internet/tags/2.3.0.2", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms, workflow : workflow, cs : cs, ks : ks});
