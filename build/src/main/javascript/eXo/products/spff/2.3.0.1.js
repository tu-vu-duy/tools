...
function getProduct(version) {
  ...
  product.codeRepo = "spff/internet/tags/2.3.0.1" ;
  ...
  var spff = Module.GetModule("spff/internet/tags/2.3.0.1", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms, workflow : workflow, cs : cs, ks : ks});
