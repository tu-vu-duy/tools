...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/suite/tags/1.0" ;
  ...
  var ecmsuite = Module.GetModule("ecm/suite/tags/1.0", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms, wcm: wcm,workflow : workflow});
