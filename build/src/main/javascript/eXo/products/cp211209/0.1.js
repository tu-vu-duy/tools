...
function getProduct(version) {
	...
	product.codeRepo = "cp211209/tags/0.1";
	...
	var cp211209 = Module.GetModule("cp211209/tags/0.1", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, cs: cs, ks: ks, dms : dms, wcm : wcm});
