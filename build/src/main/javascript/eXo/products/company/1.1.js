...
function getProduct(version) {
  ...
  product.codeRepo = "company/tags/1.1" ;
  ...
  var company = Module.GetModule("company/tags/1.1", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, ecm : ecm});
