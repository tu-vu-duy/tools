...
function getProduct(version) {
  ...
  var company = Module.GetModule("company/branches/2.0.x", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms});
