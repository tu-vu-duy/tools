...
function getProduct(version) {
  ...
  var company = Module.GetModule("company/tags/2.1.5", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms, ws : ws});
