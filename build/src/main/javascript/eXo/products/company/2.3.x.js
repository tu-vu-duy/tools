...
function getProduct(version) {
  ...
  product.codeRepo = "company/branches/2.3.x" ;
  ...
  var company = Module.GetModule("company/branches/2.3.x", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms, ws : ws});
