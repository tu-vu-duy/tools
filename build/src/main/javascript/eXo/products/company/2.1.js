...
function getProduct(version) {
  ...
  product.codeRepo = "company/tags/2.1" ;
  ...
  var company = Module.GetModule("company/tags/2.1", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms, ws : ws});
