...
function getProduct(version) {
  ...
  product.codeRepo = "company/tags/2.0" ;
  ...
  var company = Module.GetModule("company/tags/2.0", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms});
