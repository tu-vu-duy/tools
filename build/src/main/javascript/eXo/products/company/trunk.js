...
function getProduct(version) {
  ...
  var eXoJcr = Module.GetModule("patches/company/jcr/tags/1.10.6.CWI_1", {kernel : kernel, core : core, ws : ws}) ;
  var portal = Module.GetModule("patches/company/portal/tags/2.5.3.CWI_1", {kernel : kernel, ws:ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr});
  var dms = Module.GetModule("patches/company/ecm/dms/tags/2.3.2.CWI_1", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, ws : ws, eXoJcr : eXoJcr, portal : portal});
  ...
  var ks = Module.GetModule("patches/company/ks/tags/1.1.CWI_1", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
