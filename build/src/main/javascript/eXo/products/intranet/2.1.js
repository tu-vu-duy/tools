...
function getProduct(version) {
	...
	product.codeRepo = "intranet/tags/2.1" ;
	...
	var intranet = Module.GetModule("intranet/tags/2.1", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, ws : ws, eXoJcr : eXoJcr, portal : portal, cs: cs, ks: ks, dms : dms, wcm : wcm, webos : webos, allinone : allinone});
