...
function getProduct(version) {
  ...
  product.codeRepo = "intranet/tags/1.0" ;
  ...
  var intranet = Module.GetModule("intranet/tags/1.0", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, ecm : ecm});
