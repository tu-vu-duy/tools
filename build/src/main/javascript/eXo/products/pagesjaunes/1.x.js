...
function getProduct(version) {
  ...
  var pagesjaunes = Module.GetModule("pagesjaunes/branches/1.x", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms, wcm : wcm});
