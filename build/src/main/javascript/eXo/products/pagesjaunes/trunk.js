...
function getProduct(version) {
  ...
  product.codeRepo = "pagesjaunes/trunk" ;
  ...
  var pagesjaunes = Module.GetModule("pagesjaunes/trunk", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms});
