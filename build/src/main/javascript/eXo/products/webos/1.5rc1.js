...
function getProduct(version) {
  ...
  product.codeRepo = "webos/tags/1.5rc1" ;
  product.useWorkflow = false;
  product.serverPluginVersion = "2.5.2rc1" ;
  ...
  var portal = Module.GetModule("portal/tags/2.5.2rc1", {kernel : kernel, ws:ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr});
  var webos = Module.GetModule("webos/tags/1.5rc1", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr });
