...
function getProduct(version) {
  ...
  product.codeRepo = "exo-int/delivery/lead-capture/tags/1.0.3";
  ...
  var leadcapture = Module.GetModule("leadcapture/tags/1.0.3", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms, ws : ws});
