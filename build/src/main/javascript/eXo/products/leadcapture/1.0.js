...
function getProduct(version) {
  ...
  var leadcapture = Module.GetModule("leadcapture/tags/1.0", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms, ws : ws});
