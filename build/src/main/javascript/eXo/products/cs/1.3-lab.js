...
function getProduct(version) {
  ...
  product.codeRepo = "cs/branches-dev/1.3lab" ;
  ...
  var cs = Module.GetModule("cs/branches-dev/1.3lab", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
