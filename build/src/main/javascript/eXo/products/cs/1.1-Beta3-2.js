...
function getProduct(version) {
  ...
  product.codeRepo = "cs/branches/1.1Beta3-2" ;
  ...
  var cs = Module.GetModule("cs/branches/1.1Beta3-2", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
