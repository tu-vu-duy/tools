...
function getProduct(version) {
  ...
  product.codeRepo = "cs/tags/1.0.1" ;
  ...
  var cs = Module.GetModule("cs/tags/1.0.1", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
