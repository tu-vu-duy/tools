...
function getProduct(version) {
  ...
  product.codeRepo = "cs/tags/1.1RC2" ;
  ...
  var cs = Module.GetModule("cs/tags/1.1RC2", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
