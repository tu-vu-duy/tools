...
function getProduct(version) {
  ...
  product.codeRepo = "cs/branches/1.0.1" ;
  ...
  var cs = Module.GetModule("cs/branches/1.0.1", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
