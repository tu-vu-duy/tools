...
function getProduct(version) {
  ...
  product.codeRepo = "portal/tags/2.5.3rc2" ;
  product.serverPluginVersion = "2.5.3rc2"
  ...
  var portal = Module.GetModule("portal/tags/2.5.3rc2", {kernel : kernel, ws:ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr});
