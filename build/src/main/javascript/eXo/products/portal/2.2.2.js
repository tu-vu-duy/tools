...
function getProduct(version) {
  ...
  product.codeRepo = "portal/branches/2.2.2" ;
  product.serverPluginVersion = "2.2.2-SNAPSHOT" ;
  ...
  var portal = Module.GetModule("portal/branches/2.2.2", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr});
