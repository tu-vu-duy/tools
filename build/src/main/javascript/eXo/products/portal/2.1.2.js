...
function getProduct(version) {
  ...
  product.codeRepo = "portal/branches/2.1.2" ;
  ...
  var portal = Module.GetModule("portal/branches/2.1.2", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr});
