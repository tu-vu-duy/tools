...
function getProduct(version) {
  ...
  product.codeRepo = "portal/branches/2.2.3" ;
  product.serverPluginVersion = "2.2.3-SNAPSHOT" ;
  ...
  var portal = Module.GetModule("portal/branches/2.2.3", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr});
