...
function getProduct(version) {
  ...
  product.codeRepo = "portal/tags/2.6-dev1" ;
  product.serverPluginVersion = "2.6-dev1"
  ...
  var portal = Module.GetModule("portal/tags/2.6-dr1", {kernel : kernel, ws:ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr});
