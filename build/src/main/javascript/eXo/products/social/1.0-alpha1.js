...
function getProduct(version) {
  ...
  product.codeRepo = "social/tags/1.0-alpha1" ;
  ...
  var social = Module.GetModule("social/tags/1.0-alpha1", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
