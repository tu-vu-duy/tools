...
function getProduct(version) {
  ...
  product.codeRepo = "cg38/branches/2.1" ;
  ...
  var cg38 = Module.GetModule("cg38/branches/2.1", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, ecm : ecm, wcm : wcm});
