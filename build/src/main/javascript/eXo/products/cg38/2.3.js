...
function getProduct(version) {
  ...
  product.codeRepo = "cg38/tags/2.3" ;
  //product.useWorkflow = true;
  //product.workflowVersion = "2.2.0.CG38_6";
  product.serverPluginVersion = "2.5.0.CG38_6" ;
  ...
  var eXoPortletContainer = Module.GetModule("portlet-container/tags/2.0.4.CG38_6", {kernel : kernel, core : core}) ;
  var eXoJcr = Module.GetModule("jcr/tags/1.10.1", {kernel : kernel, core : core, ws : ws}) ;
  var portal = Module.GetModule("portal/tags/2.5.0.CG38_6", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr });
  var ecm = Module.GetModule("ecm/dms/tags/2.2.0.CG38_6", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, ws : ws, eXoJcr : eXoJcr, portal : portal});
  var wcm = Module.GetModule("ecm/wcm/tags/1.0.0.CG38_6", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, ecm : ecm});
  var cs = Module.GetModule("cs/tags/1.2.0.CG38_6", {kernel : kernel, ws : ws, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
  var cg38 = Module.GetModule("cg38/tags/2.3", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, ecm : ecm, wcm : wcm});
