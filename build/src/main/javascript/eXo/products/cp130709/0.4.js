...
function getProduct(version) {
  ...
  product.codeRepo = "cp130709/tags/0.4" ;
  ...
  var cp130709 = Module.GetModule("cp130709/tags/0.4", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms});
  ...
  product.addDependencies(cp130709.portlet.genericPortlet) ;

  // -- contactPortlet
  product.addDependencies(cp130709.portlet.contactPortlet) ;
  ...
  product.addDependencies(cp130709.tools.core) ;
