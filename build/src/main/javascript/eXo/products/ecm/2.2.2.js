...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/dms/tags/2.2.2" ;
  product.useWorkflow = true;
  product.workflowVersion = "2.2.2" ;
  ...
  var ecm = Module.GetModule("ecm/dms/tags/2.2.2", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, ws : ws, eXoJcr : eXoJcr, portal : portal});
