...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/branches/2.1.1" ;
  ...
  var portal = Module.GetModule("portal/branches/2.2", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr });
  var ecm = Module.GetModule("ecm/branches/2.1.1", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
