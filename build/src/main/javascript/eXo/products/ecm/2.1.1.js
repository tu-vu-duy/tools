...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/dms/tags/2.1.1" ;
  ...
  var eXoJcr = Module.GetModule("jcr/tags/1.9.2") ;
  ...
  var ecm = Module.GetModule("ecm/dms/tags/2.1.1", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
