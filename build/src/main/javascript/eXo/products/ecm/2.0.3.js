...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/branches/2.0.3" ;
  ...
  var ecm = Module.GetModule("ecm/branches/2.0.3", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
