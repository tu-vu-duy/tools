...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/dms/tags/2.0" ;
  ...
  var ecm = Module.GetModule("ecm/dms/tags/2.0", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
