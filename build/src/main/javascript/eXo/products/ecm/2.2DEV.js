...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/branches-dev/ws-2.0-test" ;
  ...
  var ecm = Module.GetModule("ecm/branches-dev/ws-2.0-test", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, ws : ws, eXoJcr : eXoJcr, portal : portal});
