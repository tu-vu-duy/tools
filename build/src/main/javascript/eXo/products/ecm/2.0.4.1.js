...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/branches/2.0.4.1" ;
  product.useWorkflow = true;
  product.workflowVersion = "2.0.4.1" ;
  ...
  var ecm = Module.GetModule("ecm/branches/2.0.4.1", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
