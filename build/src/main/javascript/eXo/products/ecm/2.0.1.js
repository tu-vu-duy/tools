...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/branches/2.0.1" ;
  ...
  var portal = Module.GetModule("portal/tags/2.0", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr });
  var ecm = Module.GetModule("ecm/branches/2.0.1", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
