...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/tags/2.0.4" ;
  ...
  var ecm = Module.GetModule("ecm/tags/2.0.4", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
