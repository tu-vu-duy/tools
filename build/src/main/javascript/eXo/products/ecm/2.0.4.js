...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/branches/2.0.4" ;
  ...
  var portal = Module.GetModule("portal/branches/2.1.2", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr });
  var ecm = Module.GetModule("ecm/branches/2.0.4", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal});
