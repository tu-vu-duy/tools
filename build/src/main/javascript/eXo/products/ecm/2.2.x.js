...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/dms/branches/2.2.x" ;
  product.useWorkflow = true;
  product.workflowVersion = "2.2.x" ;
  ...
  var ecm = Module.GetModule("ecm/dms/branches/2.2.x", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, ws : ws, eXoJcr : eXoJcr, portal : portal});
