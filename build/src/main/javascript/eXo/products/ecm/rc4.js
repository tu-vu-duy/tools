...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/dms/tags/rc4" ;
  product.useWorkflow = true;
  product.workflowVersion = "rc4" ;
  ...
  var ecm = Module.GetModule("ecm/dms/tags/rc4", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, ws : ws, eXoJcr : eXoJcr, portal : portal});
