...
function getProduct(version) {
  ...
  product.codeRepo = "ecm/wcm/branches/1.1.x" ;
  ...
  var wcm = Module.GetModule("ecm/wcm/branches/1.1.x", {kernel : kernel, core : core, ws : ws, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms});
