...
function getProduct(version) {
  ...
  product.codeRepo = "exo-int/delivery/lead-capture/tags/2.0";
  ...
  var leadcapture = Module.GetModule("leadcapture/tags/2.0", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, ws : ws});
