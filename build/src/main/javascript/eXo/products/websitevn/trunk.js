...
function getProduct(version) {
  ...
  product.name = "websitevn" ;
  product.portalwar = "portal.war" ;
  product.codeRepo = "websitevn/trunk" ;
  ...
  var websitevn = Module.GetModule("websitevn/trunk", {kernel : kernel, core : core, eXoPortletContainer : eXoPortletContainer, eXoJcr : eXoJcr, portal : portal, dms : dms, ws : ws});
  ...
  // replaced by "websitevn.eXoApplication.calendar"
  ...
  product.addDependencies(websitevn.eXoApplication.calendar) ;
  
  product.addDependencies(websitevn.portlet.dms) ;
  product.addDependencies(websitevn.component.web) ;
  product.addDependencies(websitevn.web.portal) ;
  product.addDependencies(websitevn.web.websitevnResources) ;
  product.addDependencies(websitevn.portlet.web) ;
  product.addDependencies(websitevn.application.rest) ;
  
  product.addDependencies(workflow.web.eXoWorkflowResources);
  product.addDependencies(workflow.portlet.workflow);
  
  product.addServerPatch("tomcat", websitevn.server.tomcat.patch) ;
  product.addServerPatch("jboss",  portal.server.jboss.patch) ;
  product.addServerPatch("jonas",  portal.server.jonas.patch) ;

  product.module = websitevn ;
